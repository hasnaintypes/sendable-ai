...
const plans = [
  {
    ...
    features: ["50 emails per month", "Basic AI generation", "2 connected inboxes", "Email templates", "Community support"],
    cta: "Get Started Free",
    highlighted: false,
  },
  {
    name: "Professional",
    description: "For sales teams and active recruiters",
    price: { monthly: 49, yearly: 39 },
    features: [
      "Unlimited emails per month",
      "Advanced AI personalization",
      "Unlimited connected inboxes",
      "Audience research & enrichment",
      "Follow-up sequences",
      "Template library",
      "Priority support",
      "API access",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto mb-8">
            Start free with 50 emails per month. Scale as you grow. No hidden fees.
          </p>
