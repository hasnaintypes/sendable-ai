...
type IntegrationKey = "gmail" | "outlook" | "googleCalendar" | "slack" | "discover" | "discord";
  ...
  const integrationsList = [
    {
      ...
      name: "Gmail",
      provider: "Google",
      description: "Connect your Gmail account to send personalized cold emails, track opens and replies, and manage all your outreach campaigns directly from your inbox with full Gmail API integration.",
    ...
    },
    {
      ...
      name: "Outlook",
      provider: "Microsoft",
      description: "Seamlessly integrate with Microsoft Outlook or Office 365 to send emails, sync contacts, schedule meetings, and automate your email campaigns with Microsoft Graph API.",
    ...
    },
    {
      ...
      provider: "Google",
      description: "Automatically schedule follow-up meetings, sync events with your leads, set reminders for outreach activities, and manage your sales pipeline with intelligent calendar integration.",
    ...
    },
    {
      ...
      name: "Slack",
      provider: "Slack",
      description: "Get instant notifications in your Slack workspace when leads respond, campaigns complete, or important events occur. Keep your team informed and collaborate on outreach strategies in real-time.",
    ...
    },
    {
      ...
      name: "Discord",
      provider: "Discord",
      description: "Receive real-time notifications and alerts in your Discord server when leads engage with your campaigns. Share updates with your team and collaborate on outreach strategies through Discord webhooks.",
